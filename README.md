...
# 2. Tạo môi trường — dùng conda (Python 3.10)
...
> **Lưu ý:** Project yêu cầu Python **3.10**. Không dùng `.venv` tạo từ Python 3.13 — một số package (torch, chromadb) chưa tương thích đầy đủ.
